...
@section('content')
    ...
    <div class="page-header d-flex align-items-center justify-content-between flex-wrap gap-3">
        <div>
            <h1><i class="bi bi-plus-circle me-2"></i>Tambah Data Produksi</h1>
            <p>Isi formulir di bawah ini untuk menambahkan data produksi baru.</p>
        </div>
    ...
    <div class="card-custom" style="max-width: 720px;">
        ...
        <form action="{{ route('produksi.store') }}" method="POST" novalidate>
            @csrf
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    @enderror
                    <small class="text-muted">Kode unik. Saran otomatis: <strong>{{ $kode }}</strong></small>
                </div>
                    ...
                    <div class="d-flex gap-3 flex-wrap mt-1">
                        @foreach(['Planning', 'On Progress', 'Done'] as $statusOption)
                            @php
                                ...
                                $isSelected = old('status', 'Planning') === $statusOption;
                            @endphp
            ...
            <div class="d-flex align-items-center gap-3">
                <button type="submit" class="btn-primary-custom">
                    <i class="bi bi-floppy-fill"></i> Simpan Data
                </button>
